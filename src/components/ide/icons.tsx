...
const LINK_MOTIVE =
  "M11.5 5A1.5 1.5 0 0 0 10 6.5a1.5 1.5 0 0 0 1 1.41V9h-.5a.5.5 0 0 0 0 1h.5v2.977c-1.695-.139-3-.97-3-1.977h1L7 9v2c0 1.657 2.015 3 4.5 3s4.5-1.343 4.5-3V9l-2 2h1c0 1.007-1.305 1.838-3 1.977V10h.5a.5.5 0 0 0 0-1H12V7.91a1.5 1.5 0 0 0 1-1.41A1.5 1.5 0 0 0 11.5 5m0 1a.5.5 0 1 1 0 1 .5.5 0 0 1 0-1";

export function FolderLinkIcon({ open, ...rest }: IconProps & { open?: boolean }) {
  return (
    <Base viewBox="0 0 16 16" label={open ? "Open projects folder" : "Projects folder"} {...rest}>
      <path fill="#7e57c2" d={open ? FOLDER_OPEN : FOLDER_CLOSED} />
      <path fill="#d1c4e9" d={LINK_MOTIVE} />
    </Base>
  );
}
